...
final class DebugStatementsCheck implements Check
{
    ...
    {
        return 'Leftover debug calls (dd, dump, var_dump, print_r, ray) in source code.';
    }
                ...
                if (preg_match_all($pattern, $contents, $matches, PREG_OFFSET_CAPTURE)) {
                    foreach ($matches[1] as $i => $name) {
                        ...
                        $findings[] = new Finding(
                            ...
                            message: 'Debug statement: ' . $name[0] . '(...)',
                            file: $rel,
                            line: $line,
                            suggestion: 'Remove the debug call before shipping; use Log::debug() if you really need it.',
                            snippet: $snippet,
                        );
                    }
                }
